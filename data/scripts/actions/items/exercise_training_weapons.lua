...
local function exerciseTrainingEvent(playerId, tilePosition, weaponId, dummyId)
	...
	_G.OnExerciseTraining[playerId].event = addEvent(exerciseTrainingEvent, vocation:getAttackSpeed() / configManager.getFloat(configKeys.RATE_EXERCISE_TRAINING_SPEED), playerId, tilePosition, weaponId, dummyId)
	return true
end
