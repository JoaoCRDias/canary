...
GameStore.Categories = {
	...
	-- Exclusive
	{
		...
		name = "Exclusives",
		rookgaard = true,
		subclasses = { "Portables", "Tokens", "Items", "Specials", "Forge System", "Wheel System", "Sets" },
	},
	{
		...
		offers = {
			{
				...
				itemtype = 43946,
				count = 1,
				description = "<i>Give you 20 points on wheel of destiny</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM_UNIQUE,
			},
			{
				...
				itemtype = 43947,
				count = 1,
				description = "<i>Give you 40 points on wheel of destiny</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM_UNIQUE,
			},
			{
				name = "Revised revised Promotion Scroll",
				price = 150,
				itemtype = 43948,
				count = 1,
				description = "<i>Give you 60 points on wheel of destiny</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM_UNIQUE,
			},
			{
				...
				itemtype = 43949,
				count = 1,
				description = "<i>Give you 80 points on wheel of destiny</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM_UNIQUE,
			},
			{
				...
				itemtype = 43950,
				count = 1,
				description = "<i>Give you 100 points on wheel of destiny</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM_UNIQUE,
			},
		},
	},
	-- Consumables
	{
		...
		name = "Consumables",
		rookgaard = true,
		subclasses = { "Blessings", "Infinite Kegs", "Exercise Weapons", "Potions", "Runes" },
	},
		...
		offers = {
			{
				...
				price = 500,
				itemtype = 25907,
				description = "<i>Provide you 200 supreme health potions at the same price of NPC!</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM_UNIQUE,
			},
			{
				...
				price = 500,
				itemtype = 25911,
				description = "<i>Provide you 200 ultimate mana potion at the same price of NPC!</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM_UNIQUE,
			},
			{
				...
				price = 500,
				itemtype = 25914,
				description = "<i>Provide you 200 ultimate spirit potions at the same price of NPC!</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM_UNIQUE,
			},
		},
	},
	...
	-- House ~ Upgrades
	{
		...
		offers = {
...

			{
				...
				itemtype = 59305,
				count = 1,
				description = "{info} 10% more exp than public dummy\n{info} can only be used by 6 characters at a time\n{house}\n{box}\n{storeinbox}\n{usablebyall}\n{info} can only be used by 6 characters at a time\n{backtoinbox}",
				type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
			},
			{
			...
			{
				name = "Nature Woman Exercise Dummy",
				price = 500,
				itemtype = 61132,
				count = 1,
				description = "{info} 10% more exp than public dummy\n{info} can only be used by 6 characters at a time\n{house}\n{box}\n{storeinbox}\n{usablebyall}\n{info} can only be used by 6 characters at a time\n{backtoinbox}",
			...
			{
				name = "Undead Soldier Exercise Dummy",
				price = 500,
				itemtype = 62381,
				count = 1,
				description = "{info} 10% more exp than public dummy\n{info} can only be used by 6 characters at a time\n{house}\n{box}\n{storeinbox}\n{usablebyall}\n{info} can only be used by 6 characters at a time\n{backtoinbox}",
