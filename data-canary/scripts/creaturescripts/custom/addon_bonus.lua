...
function addonBonus.onLogin(player)
	...
	conditions.noble1:setParameter(CONDITION_PARAM_STAT_MAXHITPOINTS, 5)

	conditions.noble2:setParameter(CONDITION_PARAM_TICKS, -1)
	conditions.noble2:setParameter(CONDITION_PARAM_STAT_MAXHITPOINTS, 10)

	conditions.noble3:setParameter(CONDITION_PARAM_TICKS, -1)
	conditions.noble3:setParameter(CONDITION_PARAM_STAT_MAXHITPOINTS, 15)
	...
	elseif lookType == 138 or lookType == 130 then -- Noblewoman or Nobleman outfit
		if lookAddons == 1 then -- if player is using the first addon
